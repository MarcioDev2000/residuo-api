...
export default class Transacaos extends BaseSchema {
  ...
  public async up () {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.enum('status', ['pendente', 'concluida', 'cancelada', 'pagamento_realizado', 'recebido']).defaultTo('pendente');
      ...
      table.timestamp('data_expiracao_reserva', { useTz: true }).nullable()  // Data e hora de expiração dsa reserva
